...
def run_simulation():
    ...
    prompt = "Temukan 2 caffe instragammable di Surabaya dengan rating minimal 4 dan reviews lebih dari 50 dan kurang dari 200 dengan harga di antara 20.000 sampai 100.000 yang buka pada jam 10 pagi sampai 6 malam"
