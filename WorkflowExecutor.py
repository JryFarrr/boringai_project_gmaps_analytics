...
def run_simulation():
    ...
    prompt = "Cari 3 restaurant di Jakarta Selatan yang memiliki rating di atas 4.5, dengan harga terjangkau, dengan jumlah review minimal 30 buka dari jam 9 pagi sampai 10 malam"
